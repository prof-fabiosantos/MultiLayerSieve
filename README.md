...
| **feature\_names**  | Lista com os nomes das features a serem consideradas pelo modelo (ex: `["idade", "altura", "peso"]`).<br><br>**O que faz:**<br>- Permite que o modelo saiba a ordem e quais variáveis do dataset serão usadas nas peneiras.<br>- Facilita interpretar e customizar as regras das peneiras.                                       | **Dica:**<br>- Sempre informe se quiser garantir correspondência correta com as colunas do dataset.<br>- Útil para datasets com nomes de colunas explícitos ou seleção dinâmica de variáveis.          |
